...
| RF-08 | `src/retriever.py`, `src/retrieve.py` | `tests/test_retriever.py` | `diagrams/secuencia_consulta.mmd`, `03_flujos.md` §3.1 |
| … | … | … | … |
...
| ADR-014 | OE3 | RF-07, RF-08 | Retriever (`src/retriever.py`, `src/retrieve.py`) | P-22, P-27 | ✅ |
